...
@Table(name = "JNJREPOSITORY_STAGING")
@Entity(name = "jnjrepository_Staging")
@NamePattern("%s %s|api,description")
public class Staging extends StandardEntity {
    private static final long serialVersionUID = 7547959041947492198L;
